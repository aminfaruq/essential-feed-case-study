...
class ValidateFeedCacheUseCaseTest: XCTestCase {
    ...
    func test_validateCache_doesNotDeleteNonExpiredChance() {
    ...
    func test_validateCache_deletesChanceOnExpiration() {
        let feed = uniqueImageFeed()
        let fixedCurrentDate = Date()
    ...
    func test_validateCache_deletesExpiredChance() {
        let feed = uniqueImageFeed()
        let fixedCurrentDate = Date()
...
extension ValidateFeedCacheUseCaseTest {
    // MARK: - Helpers
